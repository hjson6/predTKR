...
directoryPath = [fileparts(pwd) '\Models\Reference']; % Replace with your directory path
...
s.modelName = ['\Reference\' fileNames];
s.meshVal  = 100;
s.numIter  = 1e3;
s.convTol  = 1e-4;
...
s.knee     = 1; % 1: uncon, 2: con, 3: con init&fin
...
w_init.K1L = [ 2.50, 1.0, 0.05, 0.004, 0.90, 1, 1, 1, 1, 1, 1 ];
